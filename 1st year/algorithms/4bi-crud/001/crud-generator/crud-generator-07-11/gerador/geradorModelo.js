...
class GeradorCRUD 
{
    ...
    gerarModel() //R
    {
        ...
        this.codigoFonte += "          this.posicaoNaLista = posicaoNaLista;\n"
        this.codigoFonte += "   }\n}\n";
    }
    ...
    gerarController()
    {
        ...
        function obterFuncaoSalvar(esseGerador)
        {
            ...
            resposta += `switch (oQueEstaFazendo) {
                        case 'inserindo':
                            entidadeAtualGlobal = new ${esseGerador.nomeClasse}(${atributosListados});
                            listaDados.push(entidadeAtualGlobal);
                            mostrarAviso("Inserido na lista");
                            break;
                        case 'alterando':
                            let entidadeAtualAlterada = new ${esseGerador.nomeClasse}(${atributosListados});
