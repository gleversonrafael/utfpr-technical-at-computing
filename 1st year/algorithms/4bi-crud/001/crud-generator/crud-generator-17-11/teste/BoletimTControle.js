...
switch (oQueEstaFazendo) {
                        case 'inserindo':
                            entidadeAtualGlobal = new BoletimT(id,materia,nota1,nota2, listaDados.length);
                            listaDados.push(entidadeAtualGlobal);
                            mostrarAviso("Inserido na lista");
                            break;
                        case 'alterando':
                            let entidadeAtualAlterada = new BoletimT(id,materia,nota1,nota2, listaDados[entidadeAtualGlobal.posicaoNaLista]);
